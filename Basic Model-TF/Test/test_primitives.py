"""Tests for economic primitives and transitions."""

# Test/test_primitives.py
# test_primitives.py is a unit test suite for your economic primitives
# This file tests:
# simple numeric correctness
# shape correctness
# basic monotonic sanity checks
# numerical stability (finite, positive)
...
def test_beta_from_r_basic():
    """Verify the discount factor implied by the interest rate."""
    r = 0.04
    b = beta_from_r(r)
...
def test_reward_basic_finite_and_shapes():
    """Verify reward calculations are finite and correctly shaped."""
    mp = ModelParams()
...
def test_reward_basic_increases_with_z_holding_other_fixed():
    """Verify reward rises with productivity holding other inputs fixed."""
    mp = ModelParams()
...
def test_shock_next_z_positive_and_finite():
    """Verify simulated next-period productivity stays positive and finite."""
    mp = ModelParams()
