...
class TFCheckpointIO:
    ...
    Args:
        ...
        multiplier: Optional KKT multiplier model for Objectives 2 and 3.
        opt_multiplier: Optional optimizer associated with the multiplier model.
    ...
    multiplier: Optional[tf.Module] = None
    opt_multiplier: Optional[tf.keras.optimizers.Optimizer] = None
    max_to_keep: int = 3
    ...
    def __post_init__(self) -> None:
        ...
        if self.multiplier is not None:
            tracked_objects["multiplier"] = self.multiplier
        if self.opt_multiplier is not None:
            tracked_objects["opt_multiplier"] = self.opt_multiplier
