...
# The comment is just the file path reminder.
# does the same thing as in config.py: delays evaluation of type hints.
...
class JSONLLogger:
    ...
    # NO need to modify path: str just because we are in Colab
    # Relative paths work out of the box
    # Folders are created automatically
    # Only change paths if you explicitly want to save to Google Drive

    def __post_init__(self) -> None:
        # __init__ is auto-generated
        # __post_init__ runs immediately after that
...
class TFCheckpointIO:
    ...
    def __post_init__(self) -> None:
        ...
        # TF will track model variables,optimizer slot variables(Adam’s moments)
    ...
    # Else restore from latest checkpoint and return True
    ...
    # Saves a new checkpoint, labeled with step.
