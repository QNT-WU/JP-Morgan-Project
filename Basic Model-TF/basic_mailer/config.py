...
@dataclass(frozen=True)
class Obj2Params:
    """Objective-2-specific KKT/Euler loss weights.

    Attributes:
        nu_lambda: Weight on the multiplier-consistency / stationarity block.
    """
...
@dataclass(frozen=True)
class Obj3Params:
    """Objective-3-specific Bellman/KKT loss weights.

    Attributes:
        nu_fb: Weight on the Fischer--Burmeister complementarity block.
        nu_lambda: Weight on the multiplier-consistency / stationarity block.
    """
