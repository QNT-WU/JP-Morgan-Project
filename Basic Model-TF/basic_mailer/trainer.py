...
from .config import ModelParams, NetParams, Obj2Params, Obj3Params, TrainParams
...
def train_objective_2(
    ...
    jsonl_logger: Optional[JSONLLogger] = None,
    ckptio: Optional[TFCheckpointIO] = None,
) -> Tuple[PolicyNet, MultiplierNet, Dict[str, List[float]]]:
...
def train_objective_3(
    ...
    jsonl_logger: Optional[JSONLLogger] = None,
    ckptio: Optional[TFCheckpointIO] = None,
) -> Tuple[PolicyNet, ValueNet, MultiplierNet, Dict[str, List[float]]]:
