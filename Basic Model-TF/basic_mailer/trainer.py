...
def train_objective_1(
    ...
    # “build” the networks once right after creating them
    ...
    for epoch in range(1, tp.epochs + 1):
        ...
        # refresh every K epochs, not every step (it is too costly)
        ...
        # Test states come from the ergodic distribution induced by current policy
        ...
        # Compute Obj1 Euler diagnostic on test states
