...
2. **Objective 2** — KKT/Euler residual minimization with a learned multiplier and Fischer--Burmeister complementarity
3. **Objective 3** — Bellman residual minimization with KKT/Fischer--Burmeister max-removal
...
- subclassed `tf.keras.Model` objects for policy, value, and KKT multiplier networks
